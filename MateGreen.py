...
class MateGreen:
    ...
    def execute_entry(self, signal):
        ...
        try:
            ...
            order = self.api.open_test_position(side=signal['side'].capitalize(), quantity=signal['position_size'] if int(signal['position_size'])>1 else int(signal['position_size'])+1*2)
